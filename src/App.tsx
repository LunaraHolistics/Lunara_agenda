  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-100 dark:bg-black">
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-gray-50 dark:bg-black relative">
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 flex flex-row items-center justify-around bg-white dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-800 pb-2 pt-1 px-1 h-16 overflow-x-auto no-scrollbar z-50">
